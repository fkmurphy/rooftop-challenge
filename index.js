...
function areSequential(blockOne, blockTwo) {
...
function findNext(value, position, blocks) {
    let nextBlock = blocks.slice(position + 1).find(block => areSequential(value, block));
